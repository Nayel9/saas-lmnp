...
async function resolveUserId() {
  ...
  if (!url || !key) {
    throw new Error(
      "Variables NEXT_PUBLIC_SUPABASE_URL et SUPABASE_SERVICE_ROLE_KEY requises pour le seed.",
    );
  }
  ...
  if (!listRes.ok)
    throw new Error("Echec récupération users: " + listRes.status);
  ...
  if (!user)
    throw new Error(
      "Aucun utilisateur trouvé pour seed. Créez un compte via /login.",
    );
    ...
    await prisma.asset.createMany({
      data: [
        ...
        },
        {
          ...
          amount_ht: 1500.0,
          duration_years: 7,
          acquisition_date: new Date("2024-07-15"),
          account_code: "2183",
        },
      ],
    });
    ...
    await prisma.journalEntry.createMany({
      data: [
        ...
        },
        {
          ...
          designation: "Honoraires comptable",
          tier: "Cabinet Y",
          account_code: "622",
          amount: 300.0,
          currency: "EUR",
