...
describe('generateJournalPdf', () => {
  it('génère un PDF non vide avec totaux', async () => {
    const buf = await generateJournalPdf({
      ...
      rows: [
        { date: new Date('2025-01-05'), designation: 'Test A', tier: 'Fournisseur X', account_code: '606', amount: 123.45 },
        { date: new Date('2025-01-10'), designation: 'Test B', tier: 'Fournisseur Y', account_code: '606', amount: 54.55 },
      ],
