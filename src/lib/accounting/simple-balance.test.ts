...
import { computeVNC, computeCashAndDeposits, computeSimpleBalance } from './simple-balance';
...
describe('simple-balance (unit)', () => {
  ...
  it('VNC = coût – amort cumulé (linéaire, prorata 1ère année)', () => {
    const assets = [
      { amount_ht: 12000, duration_years: 5, acquisition_date: d('2024-04-15') }, // 2024 dotation ~ 9/12 * 2400 = 1800; 2025 dot=2400; cumul fin 2025=4200; VNC=7800
      { amount_ht: 10000, duration_years: 10, acquisition_date: d('2023-01-10') }, // cumul fin 2025 = 3000; VNC=7000
    ];
  ...
  it('Trésorerie MVP = ventes (hors cautions) – achats sur l’année', () => {
    const entries = [
      ...
      { type: 'vente' as const, amount: 200, date: d('2025-03-01'), isDeposit: true },
  ...
  it('computeSimpleBalance assemble ACTIF/PASSIF et calcule écart', () => {
    const assets = [{ amount_ht: 12000, duration_years: 5, acquisition_date: d('2024-04-15') }];
    const entries = [ { type: 'vente' as const, amount: 1000, date: d('2025-01-10') } ];
