...
import { normalizeMimeType, presignBodySchema, createAttachmentSchema, MAX_FILE_SIZE } from './uploads';
...
describe('uploads validation', () => {
  ...
  it('zod schema enforces max size', () => {
    const base = { fileName: 'a.pdf', fileSize: 123, mimeType: 'application/pdf', entryId: 'b2d7c2cd-8d8c-4f03-b224-2c2f9b5e9f7b' };
  ...
  it('createAttachment schema ok', () => {
    const base = { entryId: 'b2d7c2cd-8d8c-4f03-b224-2c2f9b5e9f7b', fileName: 'a.pdf', fileSize: 99, mimeType: 'application/pdf', storageKey: 'k' };
