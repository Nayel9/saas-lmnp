...
export const metadata: Metadata = {
    ...
    description: 'Automatisez amortissements, journaux et exports fiscaux LMNP (2033C, 2033E, 2033A). Essayez gratuitement – plan gratuit 20 écritures.',
...
export default function RootLayout({children}: { children: React.ReactNode }) {
    ...
    return (
        ...
        <head>
            ...
            {/* favicon géré par metadata.icons */}
        </head>
