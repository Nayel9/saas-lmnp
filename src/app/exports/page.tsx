  ...
  return (
    <main className="p-6 max-w-3xl mx-auto space-y-6">
      <header>
        ...
        <p className="text-sm text-muted-foreground">Téléchargez un ZIP des pièces jointes par période et par bien.</p>
      </header>
      <section className="card p-4">
        <ExportAttachmentsClient properties={properties.map(p => ({ id: p.id, label: p.label }))} />
      </section>
    </main>
  );
}
